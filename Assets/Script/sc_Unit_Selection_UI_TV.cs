...
public class sc_Unit_Selection_UI_TV : MonoBehaviour
{
    Camera myCam;
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            {
                sc_Unit_Selection_Manager_TV.instance.DeselectAll();
                SelectUnits();
            }
    ...
    void SelectUnits()
    {
        foreach (var unit in sc_Unit_Selection_Manager_TV.instance.allUnitList)
        {
            if (selectionBox.Contains(myCam.WorldToScreenPoint(unit.transform.position)))
            {
                sc_Unit_Selection_Manager_TV.instance.DragSelect(unit);
            }
        }
    }
}
